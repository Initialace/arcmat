...
const ProfileForm = ({ vendor, onSubmit, onCancel, isSubmitting, defaultName }) => {
    const {
        register,
        handleSubmit,
        reset,
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex items-center gap-3 pt-4">
                        <input
                            ...
                            id="isActive"
                            {...register('isActive')}
                            className="w-4 h-4 text-[#e09a74] border-gray-300 rounded focus:ring-[#e09a74]"
                        />
