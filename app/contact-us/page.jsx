...
export default function ContactUsPage() {
    ...
    const onSubmit = (data) => {
        console.log({ ...data, topic: selectedTopic });
                ...
                <Container>
                    <div >
                        ...
                        <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-8">
                            ...
                            ready to assist you.
                            <br /><br />
                            <strong>Quick answers first:</strong> Check our <Link href="#" className="underline text-gray-900 font-medium">FAQ section</Link> for
